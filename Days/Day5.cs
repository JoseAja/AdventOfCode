    ...
    class Day5
    {
        ...
        private void ManageID()
        {
            ...
            if (input.Trim().Equals("1") || input.Trim().Equals("5"))
            {
                ...
                int output = Intcode(array, null);
                Console.WriteLine("Diagnostic code:{0}", output);
            }
        }

        public int Intcode(string[] array, List<int> input)
        {
            int output = 0;
            int inputCounter = 0;
            try
        ...
        public ResultOpcode IntcodeExtended(string[] array, List<int> input, int i = 0)
        {
                        ...
                        if (checkIsANumberOption(opcode))
                        {
                            ...
                            else if (opcode.Equals("03") && array.Length > (i + 1))
                            {
                                ...
                                if (firstinput)
                                    ...
                                    inputValue = (int?)input[input.Count - 1];
                                Opcode3(ref array, i + 1, position1, parameter1, inputValue);
                                i += 2;
                                firstinput = false;
                            }
                            ...
                            {
                                int outOpcode4 = Opcode4(ref array, position1, parameter1);
        ...
        {
            return option.Equals("01") || option.Equals("02") || option.Equals("03") || option.Equals("04") || option.Equals("05") || option.Equals("06") || option.Equals("07") || option.Equals("08") || option.Equals("99");
        }
